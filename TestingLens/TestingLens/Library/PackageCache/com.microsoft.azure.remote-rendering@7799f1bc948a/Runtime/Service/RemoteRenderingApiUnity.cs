...
namespace Microsoft.Azure.RemoteRendering
{
    ...
    internal static class NativeLibraryHelpers
    {
        ...
        internal static void CheckStatus(status value)
        {
            ...
            switch (value)
            {
                ...
                case status.FeatureUnsupportedInCompositionMode:
                    throw new RRException(Result.FeatureUnsupportedInCompositionMode, fullMessage);
                ...
                case status.Timeout_Deprecated:
                    throw new RRException(Result.Timeout_Deprecated, fullMessage);
                ...
                case status.UnsupportedDisplayAdapter:
                    throw new RRException(Result.UnsupportedDisplayAdapter, fullMessage);
                ...
                case status.GraphicsBindingIncomplete:
                    throw new RRException(Result.GraphicsBindingIncomplete, fullMessage);
                ...
                case status.DomainUnreachable:
                    throw new RRException(Result.DomainUnreachable, fullMessage);
                case status.ConnectionRefused:
                    throw new RRException(Result.ConnectionRefused, fullMessage);
                case status.ConnectionFailed:
                    throw new RRException(Result.ConnectionFailed, fullMessage);
                case status.Timeout:
                    throw new RRException(Result.Timeout, fullMessage);
                case status.OutOfCapacity:
                    throw new RRException(Result.OutOfCapacity, fullMessage);
        ...
        internal static void CheckStatus(IntPtr handle, status value)
        {
            ...
            switch (value)
            {
                ...
                case status.FeatureUnsupportedInCompositionMode:
                    throw new RRException(Result.FeatureUnsupportedInCompositionMode, message, requestCorrelationVector, responseCorrelationVector);
                case status.ObjectReturnValueLast:
                ...
                case status.Timeout_Deprecated:
                    throw new RRException(Result.Timeout_Deprecated, message, requestCorrelationVector, responseCorrelationVector);
                case status.AlreadyConnected:
                ...
                case status.UnsupportedDisplayAdapter:
                    throw new RRException(Result.UnsupportedDisplayAdapter, message, requestCorrelationVector, responseCorrelationVector);
                case status.ConnectionReturnValueLast:
                ...
                case status.GraphicsBindingIncomplete:
                    throw new RRException(Result.GraphicsBindingIncomplete, message, requestCorrelationVector, responseCorrelationVector);
                case status.ManagerReturnValueLast:
                ...
                case status.DomainUnreachable:
                    throw new RRException(Result.DomainUnreachable, message, requestCorrelationVector, responseCorrelationVector);
                case status.ConnectionRefused:
                    throw new RRException(Result.ConnectionRefused, message, requestCorrelationVector, responseCorrelationVector);
                case status.ConnectionFailed:
                    throw new RRException(Result.ConnectionFailed, message, requestCorrelationVector, responseCorrelationVector);
                case status.Timeout:
                    throw new RRException(Result.Timeout, message, requestCorrelationVector, responseCorrelationVector);
                case status.OutOfCapacity:
                    throw new RRException(Result.OutOfCapacity, message, requestCorrelationVector, responseCorrelationVector);
                case status.SessionReturnValueLast:
    ...
    internal static class ProjectedObjectCache
    {
        ...
        public static void Add(ICachedObject instance)
        {
            ...
            lock (tracked)
            {
                if (!tracked.TryGetValue(instance.Cookie, out Dictionary<Type, WeakReference<ICachedObject>> cachedReferenceDictionary))
                {
                    cachedReferenceDictionary = new Dictionary<Type, WeakReference<ICachedObject>>();
                    cachedReferenceDictionary.Add(instanceType, new System.WeakReference<ICachedObject>(instance));
                    tracked[instance.Cookie] = cachedReferenceDictionary;
                    return;
                }

                if (!cachedReferenceDictionary.TryGetValue(instanceType, out WeakReference<ICachedObject> cachedReference))
                {
                    cachedReferenceDictionary.Add(instanceType, new System.WeakReference<ICachedObject>(instance));
                    return;
                }
            ...
            where T : class, ICachedObject
        {
            ...
            lock (tracked)
            {
                if (!tracked.TryGetValue(cookie, out Dictionary<Type, System.WeakReference<ICachedObject>> referenceDictionary))
                {
                    // Object is not being tracked.
                    return default;
                }

                if (!referenceDictionary.TryGetValue(instanceType, out System.WeakReference<ICachedObject> reference))
                {
                    reference = new WeakReference<ICachedObject>(null);
                    referenceDictionary.Add(instanceType, reference);
                }
    ...
    internal static partial class NativeLibrary
    {
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_color_material_get_tex_coord_mode(ulong handle, out Microsoft.Azure.RemoteRendering.TextureCoordinateGenerationMode result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_color_material_get_tex_coord_plane_u(ulong handle, out Microsoft.Azure.RemoteRendering.Plane result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_color_material_get_tex_coord_plane_v(ulong handle, out Microsoft.Azure.RemoteRendering.Plane result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_color_material_set_tex_coord_mode(ulong handle, Microsoft.Azure.RemoteRendering.TextureCoordinateGenerationMode value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_color_material_set_tex_coord_plane_u(ulong handle, Microsoft.Azure.RemoteRendering.Plane value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_color_material_set_tex_coord_plane_v(ulong handle, Microsoft.Azure.RemoteRendering.Plane value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_cut_plane_component_get_solid_edge_size(ulong handle, out float result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_cut_plane_component_set_solid_edge_size(ulong handle, float value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_debug_rendering_settings_get_custom_string(ulong handle, [MarshalAs(UnmanagedType.LPStr)] out string result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_debug_rendering_settings_get_render_custom_string(ulong handle, [MarshalAs(UnmanagedType.U1)] out bool result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_debug_rendering_settings_get_render_primitive_count(ulong handle, [MarshalAs(UnmanagedType.U1)] out bool result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_debug_rendering_settings_get_render_time_stamp(ulong handle, [MarshalAs(UnmanagedType.U1)] out bool result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_debug_rendering_settings_set_custom_string(ulong handle, [MarshalAs(UnmanagedType.LPStr)] string value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_debug_rendering_settings_set_render_custom_string(ulong handle, [MarshalAs(UnmanagedType.U1)] bool value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_debug_rendering_settings_set_render_primitive_count(ulong handle, [MarshalAs(UnmanagedType.U1)] bool value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_debug_rendering_settings_set_render_time_stamp(ulong handle, [MarshalAs(UnmanagedType.U1)] bool value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_entity_find_by_path(ulong handle, [MarshalAs(UnmanagedType.LPStr)] string path, Microsoft.Azure.RemoteRendering.StringComparison comparison, [MarshalAs(UnmanagedType.LPStr)] string path_separator, int max_result_count, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=6)] out ulong[] result, out int result_count);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_entity_find_components_of_type_in_hierarchy(ulong handle, Microsoft.Azure.RemoteRendering.ObjectType type, int max_result_count, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=4)] out ulong[] result, out int result_count);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_entity_find_entities_by_name_in_hierarchy(ulong handle, [MarshalAs(UnmanagedType.LPStr)] string name, Microsoft.Azure.RemoteRendering.StringComparison comparison, int max_result_count, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=5)] out ulong[] result, out int result_count);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_entity_get_global_transform(ulong handle, out Microsoft.Azure.RemoteRendering.Transform result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_entity_get_local_to_global_matrix(ulong handle, out Microsoft.Azure.RemoteRendering.Matrix4x4 result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_entity_get_local_transform(ulong handle, out Microsoft.Azure.RemoteRendering.Transform result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_entity_get_root(ulong handle, out ulong result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_entity_get_root_path(ulong handle, [MarshalAs(UnmanagedType.LPStr)] string path_separator, [MarshalAs(UnmanagedType.LPStr)] out string result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_entity_set_local_transform(ulong handle, Microsoft.Azure.RemoteRendering.Transform value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_graphics_binding_get_pose_mode(ulong handle, out Microsoft.Azure.RemoteRendering.PoseMode result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_graphics_binding_open_xr_vulkan_blit_remote_frame(ulong handle, Microsoft.Azure.RemoteRendering.VulkanRenderParametersAbi parameters, out Microsoft.Azure.RemoteRendering.Result result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_graphics_binding_open_xr_vulkan_prepare_render(ulong handle, Microsoft.Azure.RemoteRendering.VulkanRenderParametersAbi parameters, out Microsoft.Azure.RemoteRendering.Result result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_graphics_binding_open_xr_vulkan_update_app_space(ulong handle, ulong space_handle, out Microsoft.Azure.RemoteRendering.Result result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_hierarchical_state_override_component_get_override_material(ulong handle, out ulong result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_hierarchical_state_override_component_get_transparency_writes_depth_state(ulong handle, out Microsoft.Azure.RemoteRendering.HierarchicalEnableState result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_hierarchical_state_override_component_get_use_override_material_state(ulong handle, out Microsoft.Azure.RemoteRendering.HierarchicalEnableState result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_hierarchical_state_override_component_set_override_material(ulong handle, ulong value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_hierarchical_state_override_component_set_transparency_writes_depth_state(ulong handle, Microsoft.Azure.RemoteRendering.HierarchicalEnableState value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_hierarchical_state_override_component_set_use_override_material_state(ulong handle, Microsoft.Azure.RemoteRendering.HierarchicalEnableState value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_mesh_get_resource_state_async_experimental(ulong handle, Microsoft.Azure.RemoteRendering.PromiseSafeHandle promiseHandle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_get_mask_offset(ulong handle, out Microsoft.Azure.RemoteRendering.Float2 result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_get_mask_rotation_angle(ulong handle, out float result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_get_mask_rotation_center(ulong handle, out Microsoft.Azure.RemoteRendering.Float2 result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_get_mask_rotation_speed(ulong handle, out float result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_get_mask_scale(ulong handle, out Microsoft.Azure.RemoteRendering.Float2 result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_get_mask_scale_to_fit(ulong handle, [MarshalAs(UnmanagedType.U1)] out bool result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_get_mask_scroll_speed(ulong handle, out Microsoft.Azure.RemoteRendering.Float2 result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_get_mask_texture(ulong handle, out ulong result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_set_mask_offset(ulong handle, Microsoft.Azure.RemoteRendering.Float2 value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_set_mask_rotation_angle(ulong handle, float value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_set_mask_rotation_center(ulong handle, Microsoft.Azure.RemoteRendering.Float2 value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_set_mask_rotation_speed(ulong handle, float value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_set_mask_scale(ulong handle, Microsoft.Azure.RemoteRendering.Float2 value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_set_mask_scale_to_fit(ulong handle, [MarshalAs(UnmanagedType.U1)] bool value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_set_mask_scroll_speed(ulong handle, Microsoft.Azure.RemoteRendering.Float2 value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_outline_settings_set_mask_texture(ulong handle, ulong value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_pbr_material_get_normal_map_scale(ulong handle, out float result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_pbr_material_set_normal_map_scale(ulong handle, float value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_rendering_connection_get_root_entities(ulong handle, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=2)] out ulong[] result, out int result_count);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_rendering_connection_spatial_query_aabb_async(ulong handle, Microsoft.Azure.RemoteRendering.SpatialQueryAabb query, Microsoft.Azure.RemoteRendering.PromiseSafeHandle promiseHandle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_rendering_connection_spatial_query_async(ulong handle, Microsoft.Azure.RemoteRendering.SpatialQuery query, Microsoft.Azure.RemoteRendering.PromiseSafeHandle promiseHandle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_rendering_connection_spatial_query_obb_async(ulong handle, Microsoft.Azure.RemoteRendering.SpatialQueryObb query, Microsoft.Azure.RemoteRendering.PromiseSafeHandle promiseHandle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_rendering_connection_spatial_query_sphere_async(ulong handle, Microsoft.Azure.RemoteRendering.SpatialQuerySphere query, Microsoft.Azure.RemoteRendering.PromiseSafeHandle promiseHandle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_sky_reflection_settings_get_sky_rotation(ulong handle, out Microsoft.Azure.RemoteRendering.Quaternion result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_sky_reflection_settings_set_sky_rotation(ulong handle, Microsoft.Azure.RemoteRendering.Quaternion value);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_spatial_query_result_addref(IntPtr handle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_spatial_query_result_get_overlaps(IntPtr handle, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=2)] out ulong[] result, out int result_count);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.RemoteRendering.status arr_spatial_query_result_release(IntPtr handle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        internal static Microsoft.Azure.RemoteRendering.GraphicsBinding GraphicsBindingFactory(ulong handle, bool transfer)
        {
            ...
            switch (result)
            {
                ...
                case HandleType.GraphicsBindingOpenXrD3d11:
                    ...
                    break;
                case HandleType.GraphicsBindingOpenXrVulkan:
                    result_object = new Microsoft.Azure.RemoteRendering.GraphicsBindingOpenXrVulkan(handle, transfer);
                    break;
                default:
                    throw new ArgumentException();
            }
    ...
    /// <summary>
    /// A plane in 3d space described by 4 components A, B, C and D. In ARR, planes are defined in standard normal form, which means a 3d position (x,y,z) is on the plane when it satisfies A*x + B*y + C*z + D = 0.
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    ...
    public partial struct Sphere
    {
        ...
        /// </summary>
        public Microsoft.Azure.RemoteRendering.Double3 Center;
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    public partial struct OrientedBox
    {
        /// <summary>
        /// Center of the box.
        /// </summary>
        ...
        /// </summary>
        public Microsoft.Azure.RemoteRendering.Float3 HalfExtents;
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/performance-queries">Server-side performance queries</seealso>
    [StructLayout(LayoutKind.Sequential)]
    ...
    public partial struct PerformanceAssessment
    {
        ...
        /// </remarks>
        /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/reference/limits">Remote Rendering limitations</seealso>
        ...
        /// </summary>
        /// <remarks>
        /// This number also includes the points that are culled during rendering.
        /// That means, this number does not vary a lot across different camera positions, but the performance on the other hand may vary a lot,
        /// depending on the points culling rate.
        /// </remarks>
        /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/reference/limits">Remote Rendering limitations</seealso>
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/spatial-queries">Spatial Queries</seealso>
    [StructLayout(LayoutKind.Sequential)]
    ...
    internal struct RayCastHitAbi
    {
        ...
        /// <summary>
        /// Classifies the face type of the hit. See <see cref="RayHitType"/> for the distinct face types.
        /// </summary>
        public Microsoft.Azure.RemoteRendering.RayHitType HitType;
    ...
    /// </summary>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.RenderingConnection.SpatialQueryAsync(Microsoft.Azure.RemoteRendering.SpatialQuery)"/>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/spatial-queries">Spatial Queries</seealso>
    [StructLayout(LayoutKind.Sequential)]
    public partial struct SpatialQuery
    {
        /// <summary>
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/spatial-queries">Spatial Queries</seealso>
    [StructLayout(LayoutKind.Sequential)]
    public partial struct SpatialQueryAabb
    {
        /// <summary>
        /// The maximum number of mesh components to be returned. Use 0 for the internal maximum limit.
        /// </summary>
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/spatial-queries">Spatial Queries</seealso>
    [StructLayout(LayoutKind.Sequential)]
    public partial struct SpatialQuerySphere
    {
        /// <summary>
        /// The maximum number of mesh components to be returned. Use 0 for the internal maximum limit.
        /// </summary>
        ...
        /// The bounds in world-space to perform the query.
        /// </summary>
        public Microsoft.Azure.RemoteRendering.Sphere Sphere;
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/spatial-queries">Spatial Queries</seealso>
    [StructLayout(LayoutKind.Sequential)]
    public partial struct SpatialQueryObb
    {
        /// <summary>
        /// The maximum number of mesh components to be returned. Use 0 for the internal maximum limit.
        /// </summary>
        ...
        /// The bounds in world-space to perform the query.
        /// </summary>
        public Microsoft.Azure.RemoteRendering.OrientedBox Obb;
    ...
    /// </summary>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.RenderingSession.ConnectAsync(Microsoft.Azure.RemoteRendering.RendererInitOptions)"/>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/sessions">Remote Rendering Sessions</seealso>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/rendering-modes">Rendering modes</seealso>
    [StructLayout(LayoutKind.Sequential)]
    internal struct RendererInitOptionsAbi
    {
        ...
        /// <summary>
        /// Forces depth writing for all objects rendered with either <see cref="HierarchicalStates.SeeThrough"/>, or transparent <see cref="PbrMaterial"/>s and <see cref="ColorMaterial"/>s.
        /// </summary>
        [MarshalAs(UnmanagedType.U1)]
        ...
        public static Microsoft.Azure.RemoteRendering.RendererInitOptions Convert(Microsoft.Azure.RemoteRendering.RendererInitOptionsAbi value)
        {
            ...
            result.ForceTransparencyWritesDepth = value.ForceTransparencyWritesDepth;
    ...
    /// </summary>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/how-tos/conversion/blob-storage">Use Azure Blob Storage for model conversion</seealso>
    [StructLayout(LayoutKind.Sequential)]
    internal struct AssetConversionInputOptionsAbi
    {
        ...
        /// </summary>
        /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/how-tos/conversion/model-conversion#supported-source-formats">A list of supported file formats</seealso>
        [MarshalAs(UnmanagedType.LPStr)]
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/reference/vm-sizes">Server sizes</seealso>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/sessions">Remote Rendering Sessions</seealso>
    [StructLayout(LayoutKind.Sequential)]
    ...
    /// <seealso cref="Microsoft.Azure.RemoteRendering.RenderingSessionPropertiesResult"/>
    [StructLayout(LayoutKind.Sequential)]
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/models">Models</seealso>
    [StructLayout(LayoutKind.Sequential)]
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/textures">Textures</seealso>
    [StructLayout(LayoutKind.Sequential)]
    ...
    /// <summary>
    /// Result structure returned by <see cref="Mesh.GetResourceStateAsync_Experimental"/>.
    /// </summary>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.Mesh.GetResourceStateAsync_Experimental"/>
    [StructLayout(LayoutKind.Sequential)]
    ...
    /// <summary>
    /// When <see cref="GraphicsBindingOpenXrVulkan"/> is used, this must be filled out and passed to <see cref="GraphicsBindingOpenXrVulkan.PrepareRender(VulkanRenderParameters)"/> and <see cref="GraphicsBindingOpenXrVulkan.BlitRemoteFrame(VulkanRenderParameters)"/> once per frame.
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct VulkanRenderParametersAbi
    {
        /// <summary>
        /// Vulkan graphics queue.
        /// </summary>
        public System.IntPtr GraphicsQueue;
        ...
        /// </summary>
        public System.IntPtr CommandBuffer;
        ...
        public Microsoft.Azure.RemoteRendering.VulkanRenderParameters Convert()
        {
            return Microsoft.Azure.RemoteRendering.VulkanRenderParametersAbi.Convert(this);
        }

        public static Microsoft.Azure.RemoteRendering.VulkanRenderParameters Convert(Microsoft.Azure.RemoteRendering.VulkanRenderParametersAbi value)
        {
            Microsoft.Azure.RemoteRendering.VulkanRenderParameters result = new Microsoft.Azure.RemoteRendering.VulkanRenderParameters();

            result.GraphicsQueue = value.GraphicsQueue;
            result.QueueFamilyIndex = value.QueueFamilyIndex;
            result.CommandBuffer = value.CommandBuffer;
            result.RenderPass = value.RenderPass;
            result.Srgb = value.Srgb;
            result.SampleCount = value.SampleCount;
            result.CurrentFrameNumber = value.CurrentFrameNumber;
    ...
    /// When <see cref="GraphicsBindingOpenXrVulkan"/> is used, this must be filled out and passed to <see cref="GraphicsBindingOpenXrVulkan.PrepareRender(VulkanRenderParameters)"/> and <see cref="GraphicsBindingOpenXrVulkan.BlitRemoteFrame(VulkanRenderParameters)"/> once per frame.
    /// </summary>
    public partial struct VulkanRenderParameters
    {
        /// <summary>
        /// Vulkan graphics queue.
        /// </summary>
        ...
        internal Microsoft.Azure.RemoteRendering.VulkanRenderParametersAbi Convert()
        {
            return Microsoft.Azure.RemoteRendering.VulkanRenderParameters.Convert(this);
        }

        internal static Microsoft.Azure.RemoteRendering.VulkanRenderParametersAbi Convert(Microsoft.Azure.RemoteRendering.VulkanRenderParameters value)
        {
            Microsoft.Azure.RemoteRendering.VulkanRenderParametersAbi result = new Microsoft.Azure.RemoteRendering.VulkanRenderParametersAbi();
    ...
    /// <seealso cref="Microsoft.Azure.RemoteRendering.GraphicsBindingOpenXrVulkan"/>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/graphics-bindings">Graphics binding (Remote Rendering docs)</seealso>
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/materials">Materials (Remote Rendering docs)</seealso>
    ...
    /// </summary>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.GraphicsBinding"/>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/late-stage-reprojection">Late stage reprojection</seealso>
    ...
    /// <seealso cref="Microsoft.Azure.RemoteRendering.RenderingConnection"/>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/single-sided-rendering">Single-sided rendering</seealso>
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/override-hierarchical-state">Hierarchical state override</seealso>
    ...
    /// </summary>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.ConversionStatus"/>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.RemoteRenderingClient"/>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/how-tos/conversion/model-conversion">Model conversion</seealso>
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/pbr-materials">PBR materials</seealso>
    ...
    /// </summary>
    public enum TextureCoordinateGenerationMode : int
    {
        /// <summary>
    ...
    /// is [0;1], set <see cref="DepthConvention.ZeroToOne"/> and <see cref="DepthConvention.MinusOneToOne"/> for [-1;1].
    /// If you need an inverse Z matrix, use the respective conventions <see cref="DepthConvention.OneToZero"/> for [1;0]
    /// and <see cref="DepthConvention.OneToMinusOne"/> for [1;-1].
    /// </remarks>
    ...
    public enum PoseMode : int
    {
        ...
        /// </summary>
        /// <remarks>
        /// This mode is only available when <see cref="GraphicsBindingSimD3d11"/> is used.
        /// This mode gives the best stability at the cost of latency and is artifact-free. It is comparable to plain cloud
        /// streaming and therefore recommended for desktop apps.
        /// </remarks>
        Passthrough = 2,
    }
    ...
    /// </summary>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.ResourceStateResult_Experimental"/>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.Mesh.GetResourceStateAsync_Experimental"/>
    public enum ResourceDataSourceState_Experimental : int
    {
        /// <summary>
    ...
    /// <summary>
    /// Enum that provides a set of pre-defined string comparison methods.
    /// </summary>
    public enum StringComparison : int
    {
        /// <summary>
        /// Use case sensitive string comparison, i.e. exact byte-by-byte comparison.
        /// </summary>
        CaseSensitive = 0,
        /// <summary>
        /// Use case insensitive string comparison, in which case for instance "root" matches "Root" or "ROOT".
        /// </summary>
        CaseInsensitive = 1,
    }
    ...
    public enum HierarchicalStates : int
    {
        ...
        /// </summary>
        /// <remarks>
        /// Parts with this flag will be ignored by <see href="https://docs.microsoft.com/azure/remote-rendering/overview/features/spatial-queries">spatial queries</see>.
        /// </remarks>
        DisableCollision = 16,
        /// <summary>
        /// The use cut plane filter mask state is overridden. This flag enables individual cut plane filter masks per object. The bitmask itself is specified through <see cref="HierarchicalStateOverrideComponent.CutPlaneFilterMask"/>.
        /// </summary>
        ...
        Shell = 128,
        /// <summary>
        /// Forces depth writing, irrespective of the graph being rendered opaque or transparent.
        /// </summary>
        /// <remarks>
        /// Affects objects rendered transparent through either <see cref="HierarchicalStates.SeeThrough"/> or transparent materials.
        /// </remarks>
        TransparencyWritesDepth = 256,
        /// <summary>
        /// Uses a single override material for rendering the geometry. The material itself is assigned through <see cref="HierarchicalStateOverrideComponent.OverrideMaterial"/>.
        /// </summary>
        /// <remarks>
        /// Point cloud geometry is not affected by this feature.
        /// </remarks>
        UseOverrideMaterial = 512,
        /// <summary>
    ...
    public enum PbrMaterialFeatures : int
    {
        ...
        /// </summary>
        /// <remarks>
        /// Enabling this on transparent materials can improve the re-projection behavior of transparent objects, and hologram stability by consequence. See the respective <see href="https://docs.microsoft.com/azure/remote-rendering/overview/features/late-stage-reprojection">LSR documentation</see> for details.
        /// </remarks>
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/color-materials">Color materials</seealso>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/single-sided-rendering">Single-sided rendering</seealso>
    ...
    internal enum HandleType : int
    {
        ...
        GraphicsBindingOpenXrVulkan = 29,
    }
    ...
    /// Camera settings.
    /// </summary>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/camera">Camera</seealso>
    ...
    public partial class ColorMaterial : Material
    {
        ...
        /// Can be set to the same allowed value range as for <see cref="PbrMaterial.AlbedoColor"/> but will be clamped to [0;1] during rendering.
        /// </remarks>
        ...
        /// <summary>
        /// Defines the mode that is used to produce texture coordinates for the albedo texture. This mode is ignored if this material does not use a texture. See <see cref="TextureCoordinateGenerationMode"/> for the supported modes.
        /// </summary>
        public Microsoft.Azure.RemoteRendering.TextureCoordinateGenerationMode TexCoordMode
        {
            get
            {
                Microsoft.Azure.RemoteRendering.TextureCoordinateGenerationMode result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_color_material_get_tex_coord_mode(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_color_material_set_tex_coord_mode(this.handle, value));
            }
        }
        ...
        /// <summary>
        /// The plane that is used to calculate the u-portion of the texture coordinates in either <see cref="TextureCoordinateGenerationMode.PlanarObjectSpace"/> or <see cref="TextureCoordinateGenerationMode.PlanarWorldSpace"/> mode.
        /// </summary>
        /// <remarks>
        /// This plane is ignored for texture coordinate generation modes <see cref="TextureCoordinateGenerationMode.SourceUv0"/> and <see cref="TextureCoordinateGenerationMode.SourceUv1"/>.
        /// Scaling of the mapping is achieved by scaling the plane's normal (A, B and C), and a texture offset can be added through the plane's D component.
        /// </remarks>
        public Microsoft.Azure.RemoteRendering.Plane TexCoordPlaneU
        {
            get
            {
                Microsoft.Azure.RemoteRendering.Plane result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_color_material_get_tex_coord_plane_u(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_color_material_set_tex_coord_plane_u(this.handle, value));
            }
        }

        /// <summary>
        /// The plane that is used to calculate the v-portion of the texture coordinates in either <see cref="TextureCoordinateGenerationMode.PlanarObjectSpace"/> or <see cref="TextureCoordinateGenerationMode.PlanarWorldSpace"/> mode.
        /// </summary>
        /// <remarks>
        /// This plane is ignored for texture coordinate generation modes <see cref="TextureCoordinateGenerationMode.SourceUv0"/> and <see cref="TextureCoordinateGenerationMode.SourceUv1"/>.
        /// Scaling of the mapping is achieved by scaling the plane's normal (A, B and C), and a texture offset can be added through the plane's D component.
        /// </remarks>
        public Microsoft.Azure.RemoteRendering.Plane TexCoordPlaneV
        {
            get
            {
                Microsoft.Azure.RemoteRendering.Plane result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_color_material_get_tex_coord_plane_v(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_color_material_set_tex_coord_plane_v(this.handle, value));
            }
        }
        ...
        /// Can be set to the same allowed value range as for <see cref="PbrMaterial.FresnelEffectColor"/> but will be clamped to [0;1] during rendering.
        /// </remarks>
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/components">Components</seealso>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/lifetime">Object and resource lifetime</seealso>
    public partial class ComponentBase : ObjectBase
    {
        ...
        /// </summary>
        public new Microsoft.Azure.RemoteRendering.ObjectType Type
        {
            get
            {
    ...
    /// <summary>
    /// Result object that is returned by <see cref="RemoteRenderingClient.GetCurrentConversionsAsync"/>. Success state and additional error context can be retrieved via base class <see cref="SessionContextResult"/>. In case of success, the Conversions property holds a valid array of <see cref="ConversionProperties"/> instances.
    /// </summary>
    public partial class ConversionPropertiesArrayResult : SessionContextResult
    {
        ...
        /// <summary>
        /// In case of success, the Conversions property holds a valid array of <see cref="ConversionProperties"/> instances.
        /// </summary>
    ...
    /// <summary>
    /// Result object that is returned by <see cref="RemoteRenderingClient.GetConversionPropertiesAsync(System.String)"/>. Success state and additional error context can be retrieved via base class <see cref="SessionContextResult"/>. In case of success, the Properties property holds a valid instance of <see cref="ConversionProperties"/>.
    /// </summary>
    public partial class ConversionPropertiesResult : SessionContextResult
    {
        ...
        /// <summary>
        /// In case of success, the Properties property holds a valid instance of <see cref="ConversionProperties"/>.
        /// </summary>
    ...
    /// <summary>
    /// Result object that is returned by <see cref="RemoteRenderingClient.OpenRenderingSessionAsync(System.String)"/> and <see cref="RemoteRenderingClient.CreateNewRenderingSessionAsync(RenderingSessionCreationOptions)"/>. Success state and additional error context can be retrieved via base class <see cref="SessionContextResult"/>. In case of success, the Session property holds a valid <see cref="RenderingSession"/> reference.
    /// </summary>
    public partial class CreateRenderingSessionResult : SessionContextResult
    {
        ...
        /// <summary>
        /// In case of success this holds a valid <see cref="RenderingSession"/> reference.
        /// </summary>
    ...
    /// <seealso cref="Microsoft.Azure.RemoteRendering.Entity"/>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.RenderingConnection.CreateComponent(Microsoft.Azure.RemoteRendering.ObjectType,Microsoft.Azure.RemoteRendering.Entity)"/>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/cut-planes">Cut planes</seealso>
    public partial class CutPlaneComponent : ComponentBase
    {
        ...
        /// </para>
        /// <para>
        /// A <see cref="Result.InvalidParam"/> error occurs if a negative size is set.
        /// </para>
        /// </remarks>
        public float SolidEdgeSize
        {
            get
            {
                float result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_cut_plane_component_get_solid_edge_size(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_cut_plane_component_set_solid_edge_size(this.handle, value));
            }
        }
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/debug-rendering">Debug Rendering</seealso>
    public partial class DebugRenderingSettings
    {
        ...
        /// </summary>
        public bool RenderPrimitiveCount
        {
            get
            {
                bool result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_debug_rendering_settings_get_render_primitive_count(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_debug_rendering_settings_set_render_primitive_count(this.handle, value));
            }
        }
        ...
        public bool RenderTimeStamp
        {
            ...
            {
                bool result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_debug_rendering_settings_get_render_time_stamp(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_debug_rendering_settings_set_render_time_stamp(this.handle, value));
            }
        }

        /// <summary>
        /// Controls whether the string passed as  <see cref="DebugRenderingSettings.CustomString"/> is rendered into the frame.
        /// </summary>
        public bool RenderCustomString
        {
            get
            {
                bool result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_debug_rendering_settings_get_render_custom_string(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_debug_rendering_settings_set_render_custom_string(this.handle, value));
            }
        }

        /// <summary>
        /// User controlled string that is rendered into the frame when the <see cref="DebugRenderingSettings.RenderCustomString"/> flag is enabled. This value can be used for instance when debugging the entire latency from setting a value through the API until it's shown in remote content in the client app. Specifically, this could encode a counter that is incremented every frame and that is also rendered as local content. Then the discrepancy between these two numbers corresponds to the number of frames latency 'pose to display'. When trying to set a string longer than 64 characters, a "Status.StringTooLong" error occurs. Furthermore, the string must consist only of ASCII characters, otherwise a "Status.InvalidParam" error occurs.
        /// </summary>
        public string CustomString
        {
            ...
            {
                string result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_debug_rendering_settings_get_custom_string(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_debug_rendering_settings_set_custom_string(this.handle, value));
            }
        }
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/lights">Scene lighting</seealso>
    ...
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/entities">Entities</seealso>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/components">Components</seealso>
    public partial class Entity : ObjectBase
    {
        ...
        /// <summary>
        /// The topmost parent entity in this hierarchy. If this entity is a root entity itself (i.e. <see cref="Entity.Parent"/> is invalid) then this returns this entity.
        /// </summary>
        public Microsoft.Azure.RemoteRendering.Entity Root
        {
            get
            {
                ulong result_handle;
                Microsoft.Azure.RemoteRendering.Entity result_object;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_entity_get_root(this.handle, out result_handle));
                result_object = (result_handle != default(ulong)) ? new Microsoft.Azure.RemoteRendering.Entity(result_handle, transfer:true) : null;
                return result_object;
            }
        }
        ...
        public System.Collections.Generic.IReadOnlyList<Microsoft.Azure.RemoteRendering.Entity> Children
        {
            get
            {
                ...
                if (result_length > 0)
                {
                    Microsoft.Azure.RemoteRendering.Entity[] converted_array = new Microsoft.Azure.RemoteRendering.Entity[result_length];
                    for (int i = 0; i < result_length; i++)
                    {
                        var handle = result_array[i];
                        converted_array[i] = new Microsoft.Azure.RemoteRendering.Entity(handle, transfer:true);
                    }
                    result = converted_array;
                }
                else
                {
                    result = Array.Empty<Microsoft.Azure.RemoteRendering.Entity>();
                }
                return result;
            }
        }
        ...
        public System.Collections.Generic.IReadOnlyList<Microsoft.Azure.RemoteRendering.ComponentBase> Components
        {
            get
            {
                ...
                if (result_length > 0)
                {
                    Microsoft.Azure.RemoteRendering.ComponentBase[] converted_array = new Microsoft.Azure.RemoteRendering.ComponentBase[result_length];
                    for (int i = 0; i < result_length; i++)
                    {
                        var handle = result_array[i];
                        converted_array[i] = Factories.ComponentBaseFactory(handle, transfer:true);
                    }
                    result = converted_array;
                }
                else
                {
                    result = Array.Empty<Microsoft.Azure.RemoteRendering.ComponentBase>();
                }
                return result;
            }
        }
        ...
        /// If the full local transform needs to be set or be retrieved, <see cref="Entity.LocalTransform"/> is faster than individual calls to <see cref="Entity.Position"/>, <see cref="Entity.Rotation"/>, and <see cref="Entity.Scale"/>.
        /// </remarks>
        public Microsoft.Azure.RemoteRendering.Double3 Position
        {
            get
        ...
        /// <summary>
        /// Get or set the local transform of this entity. The same can be achieved through getting/setting <see cref="Entity.Position"/>, <see cref="Entity.Rotation"/>, and <see cref="Entity.Scale"/> individually.
        /// </summary>
        /// <remarks>
        /// A <see cref="Result.InvalidParam"/> error occurs if the given transform contains any NaN or infinite.
        /// If the full local transform needs to be set or be retrieved, <see cref="Entity.LocalTransform"/> is faster than individual calls to <see cref="Entity.Position"/>, <see cref="Entity.Rotation"/>, and <see cref="Entity.Scale"/>.
        /// </remarks>
        public Microsoft.Azure.RemoteRendering.Transform LocalTransform
        {
            get
            {
                Microsoft.Azure.RemoteRendering.Transform result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_entity_get_local_transform(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_entity_set_local_transform(this.handle, value));
            }
        }
        ...
        /// </summary>
        /// <remarks>
        /// The client-side API stores only local transform data, so internally this function needs to compute the global position by traversing up the hierarchy.
        /// Accordingly, this is a computational intensive function that should only be called when needed for a selected set of entities.
        /// However, this function is still much faster than traversing the entity hierarchy manually in client code.
        /// There is no way to set the global transform of an entity.
        /// </remarks>
        public Microsoft.Azure.RemoteRendering.Transform GlobalTransform
        {
            get
            {
                Microsoft.Azure.RemoteRendering.Transform result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_entity_get_global_transform(this.handle, out result));
                return result;
            }
        }

        /// <summary>
        /// Similar to <see cref="Entity.GlobalTransform"/> but converted to a 4x4 matrix.
        /// </summary>
        public Microsoft.Azure.RemoteRendering.Matrix4x4 LocalToGlobalMatrix
        {
            get
            {
                Microsoft.Azure.RemoteRendering.Matrix4x4 result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_entity_get_local_to_global_matrix(this.handle, out result));
                return result;
            }
        }
        ...
        /// A pre-defined string comparison method to compare each path segment against an entity's name. See <see cref="StringComparison"/>.
        /// </param>
        ...
        public System.Collections.Generic.IReadOnlyList<Microsoft.Azure.RemoteRendering.Entity> FindByPath(string path, Microsoft.Azure.RemoteRendering.StringComparison comparison, string pathSeparator, int maxResultCount)
        {
            ...
            ulong[] result_array;
            int result_length;
            Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_entity_find_by_path(this.handle, path, comparison, pathSeparator, maxResultCount, out result_array, out result_length));
            if (result_length > 0)
            {
                Microsoft.Azure.RemoteRendering.Entity[] converted_array = new Microsoft.Azure.RemoteRendering.Entity[result_length];
                for (int i = 0; i < result_length; i++)
        ...
        /// <remarks>
        /// The path separator should be chosen carefully, so it's not a potential character sequence in entity names.
        /// To describe the relative path between a parent and an entity underneath it, just take the root path of both and trim the start of the path string of the child by the length of the parent's path plus separator length.
        /// </remarks>
        public string GetRootPath(string pathSeparator)
        {
            string result;
            Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_entity_get_root_path(this.handle, pathSeparator, out result));
            return result;
        }
        ...
        /// </summary>
        /// <param name="type">
        /// Component type to search for, for instance <see cref="ObjectType.MeshComponent"/>.
        /// </param>
        /// <remarks>
        ...
        /// If you need to search the full entity sub-tree for components, use the <see cref="Entity.FindComponentsOfTypeInHierarchy(ObjectType,System.Int32)"/> function.
        /// </remarks>
        ...
        /// </summary>
        /// <param name="type">
        /// The component type to search for, for instance <see cref="ObjectType.MeshComponent"/>.
        /// </param>
        /// <param name="maxResultCount">
        ...
        public System.Collections.Generic.IReadOnlyList<Microsoft.Azure.RemoteRendering.ComponentBase> FindComponentsOfTypeInHierarchy(Microsoft.Azure.RemoteRendering.ObjectType type, int maxResultCount)
        {
            ...
            ulong[] result_array;
            int result_length;
            Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_entity_find_components_of_type_in_hierarchy(this.handle, type, maxResultCount, out result_array, out result_length));
            if (result_length > 0)
            {
                Microsoft.Azure.RemoteRendering.ComponentBase[] converted_array = new Microsoft.Azure.RemoteRendering.ComponentBase[result_length];
                for (int i = 0; i < result_length; i++)
        ...
        /// </param>
        /// <param name="comparison">
        /// A pre-defined string comparison method, see <see cref="StringComparison"/>.
        /// </param>
        /// <param name="maxResultCount">
        /// If larger than 0, this value specifies the maximum number of returned elements. For negative values or 0, no size limit is imposed.
        /// </param>
        ...
        public System.Collections.Generic.IReadOnlyList<Microsoft.Azure.RemoteRendering.Entity> FindEntitiesByNameInHierarchy(string name, Microsoft.Azure.RemoteRendering.StringComparison comparison, int maxResultCount)
        {
            ...
            ulong[] result_array;
            int result_length;
            Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_entity_find_entities_by_name_in_hierarchy(this.handle, name, comparison, maxResultCount, out result_array, out result_length));
            if (result_length > 0)
            {
                Microsoft.Azure.RemoteRendering.Entity[] converted_array = new Microsoft.Azure.RemoteRendering.Entity[result_length];
                for (int i = 0; i < result_length; i++)
        ...
        // Class extension begins for Entity.
        /// <summary>
        /// Retrieves the list of all the entities that are attached as children to this one and puts them into <param name="resultList">.
        /// </summary>
        /// <remarks>
        /// This returns the same data as <see cref="Children"/>, but won't allocate a result array.
        /// </remarks>
        public void GetChildren(List<Entity> resultList)
        {
            ...
            foreach (ulong handle in result_array)
            {
                resultList.Add(new Microsoft.Azure.RemoteRendering.Entity(handle, transfer: true));
            }
        }

        /// <summary>
        /// Returns a list of entities that are under this entity and that match the exact search path. A path is a sequence of entity names, separated by a special path delimiter character/string.
        /// For instance, a path string could be "house/table/leg4". In that example, this function would search for direct child entities named "house", from there recursively search for child
        /// entities named "table" and so on. It only returns those entities that match the full path.
        /// </summary>
        /// <remarks>
        /// Same as <see cref="FindByPath"/>, but instead of returning the result array, it fills the passed list with results. Returns true if at least one match was found.
        /// </remarks>
        /// <param name="path">The path string relative to this entity. The path separator character/string can be passed separately.</param>
        /// <param name="comparison">A pre-defined string comparison method to compare each path segment against an entity's name. See <see cref="StringComparison"/>.</param>
        /// <param name="pathSeparator">A single character (or non-empty string) that denotes a delimiter in the path string. For instance, use "/" or "\".</param>
        /// <param name="maxResultCount">The maximum number of entities to find. Use 1 to return the first result only, or a negative number for all results.</param>
        /// <param name="resultList">The list to fill with results. This function clears the list before adding new results.</param>
        /// <returns>Returns true if at least one match was found.</returns>
        public bool TryFindByPath(string path, StringComparison comparison, string pathSeparator, int maxResultCount, List <Entity> resultList)
        {
            if (resultList == null) throw new ArgumentNullException(nameof(resultList));
        ...
        /// </summary>
        /// <remarks>
        /// Same as <see cref="FindComponentsOfTypeInHierarchy"/>, but instead of returning the result array, it fills the passed list with results. Returns true if at least one match was found.
        /// </remarks>
        /// <param name="type">The component type to search for, for instance <see cref="ObjectType.MeshComponent"/>.</param>
        /// <param name="maxResultCount">If larger than 0, this value specifies the maximum number of returned elements. For negative values or 0, no size limit is imposed.</param>
        /// <param name="resultList">The list to fill with results. This function clears the list before adding new results.</param>
        /// <returns>Returns true if at least one match was found.</returns>
        public bool TryFindComponentsOfTypeInHierarchy(ObjectType type, int maxResultCount, List<ComponentBase> resultList)
        {
            if (resultList == null) throw new ArgumentNullException(nameof(resultList));
            ...
            foreach (ulong handle in result_array)
            {
                resultList.Add(Factories.ComponentBaseFactory(handle, transfer: true));
            }
            return true;
        }
        ...
        /// </summary>
        /// <remarks>
        /// Same as <see cref="FindEntitiesByNameInHierarchy"/>, but instead of returning the result array, it fills the passed list with results. Returns true if at least one match was found.
        /// </remarks>
        /// <param name="name">The name to compare against.</param>
        /// <param name="comparison">A pre-defined string comparison method, see <see cref="StringComparison"/>.</param>
        /// <param name="maxResultCount">If larger than 0, this value specifies the maximum number of returned elements. For negative values or 0, no size limit is imposed.</param>
        /// <param name="resultList">The list to fill with results. This function clears the list before adding new results.</param>
        /// <returns>Returns true if at least one match was found.</returns>
        public bool TryFindEntitiesByNameInHierarchy(string name, StringComparison comparison, int maxResultCount, List<Entity> resultList)
        {
            ulong[] result_array;
            int result_length;
            Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_entity_find_entities_by_name_in_hierarchy(this.handle, name, comparison, maxResultCount, out result_array, out result_length));
        ...
        /// <summary>
        /// Retrieves the list of all the components that are attached to this entity and puts them into <param name="resultList">.
        /// </summary>
        /// <remarks>
        /// This returns the same data as <see cref="Components"/>, but won't allocate a result array.
        /// </remarks>
        public void GetComponents(List<ComponentBase> resultList)
        {
            if (resultList == null) throw new ArgumentNullException(nameof(resultList));
        ...
        // Class extension ends for Entity.
    ...
    /// </summary>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/graphics-bindings">Graphics binding</seealso>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.GraphicsBindingWmrD3d11"/>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.GraphicsBindingOpenXrD3d11"/>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.GraphicsBindingSimD3d11"/>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.GraphicsBindingOpenXrVulkan"/>
    public partial class GraphicsBinding
    {
        ...
        /// <remarks>
        /// <para>
        /// A <see cref="Result.NotSupported"/> error occurs if <see cref="PoseMode.Remote"/> is used on Android or if <see cref="PoseMode.Passthrough"/>
        /// is set on anything other than <see cref="GraphicsBindingSimD3d11"/>.
        /// </para>
        /// </remarks>
        ...
        /// </summary>
        public Microsoft.Azure.RemoteRendering.PoseMode GetPoseMode()
        {
            Microsoft.Azure.RemoteRendering.PoseMode result;
            Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_graphics_binding_get_pose_mode(this.handle, out result));
            return result;
        }
    ...
    /// </para>
    /// <para>
    /// At runtime the only thing that needs to be done by the user is to call <see cref="GraphicsBindingOpenXrVulkan.PrepareRender(VulkanRenderParameters)"/> and then <see cref="GraphicsBindingOpenXrVulkan.BlitRemoteFrame(VulkanRenderParameters)"/> to render the remote frame to the current render target.
    /// </para>
    /// </remarks>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.GraphicsBinding"/>
    public partial class GraphicsBindingOpenXrVulkan : GraphicsBinding
    {
        internal GraphicsBindingOpenXrVulkan(ulong ahandle, bool transfer) : base(ahandle, transfer)
        {
        }
        ...
        /// </summary>
        /// <remarks>
        /// When this function is executed it is assumed that a valid VkCommandBuffer is provided and no VKRenderPass is active.
        /// Note, this function must be called every frame before calling BlitRemoteFrame.
        /// </remarks>
        ...
        {
            Microsoft.Azure.RemoteRendering.VulkanRenderParametersAbi parameters_converted = parameters.Convert();
            Microsoft.Azure.RemoteRendering.Result result;
            Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_graphics_binding_open_xr_vulkan_prepare_render(this.handle, parameters_converted, out result));
            return result;
        }
        ...
        /// </summary>
        /// <remarks>
        /// When this function is executed it is assumed that a valid VkCommandBuffer and VkRenderPass is provided.
        /// This should be done as the very first thing in each frame as this function will overwrite all content in the target Vulkan framebuffer.
        /// </remarks>
        public Microsoft.Azure.RemoteRendering.Result BlitRemoteFrame(Microsoft.Azure.RemoteRendering.VulkanRenderParameters parameters)
        {
            Microsoft.Azure.RemoteRendering.VulkanRenderParametersAbi parameters_converted = parameters.Convert();
            Microsoft.Azure.RemoteRendering.Result result;
            Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_graphics_binding_open_xr_vulkan_blit_remote_frame(this.handle, parameters_converted, out result));
            return result;
        }
        ...
        {
            Microsoft.Azure.RemoteRendering.Result result;
            Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_graphics_binding_open_xr_vulkan_update_app_space(this.handle, spaceHandle, out result));
            return result;
        }
    ...
    public partial class HierarchicalStateOverrideComponent : ComponentBase
    {
        ...
        /// <summary>
        /// The cut plane filter mask of this component. This mask is effectively used by the geometry if the <see cref="HierarchicalStates.UseCutPlaneFilterMask"/> flag is set.
        /// </summary>
        public byte CutPlaneFilterMask
        {
            get
        ...
        /// <summary>
        /// A single material for rendering the geometry that is activated through the <see cref="HierarchicalStates.UseOverrideMaterial"/> flag.
        /// </summary>
        /// <remarks>
        /// This can be an arbitrary <see cref="PbrMaterial"/> or a <see cref="ColorMaterial"/>, but some features may not work if the geometry does not have the required vertex streams, e.g. normals for
        /// proper PBR lighting or texture UV coordinates for texture mapping. Using a transparent material on opaque geometry will only work reliably in <see cref="ServiceRenderMode.TileBasedComposition"/>.
        /// Point cloud geometry is not affected by this feature.
        /// By default, the material reference is unassigned which has the same effect as disabling the feature through the <see cref="HierarchicalStates.UseOverrideMaterial"/> flag.
        /// </remarks>
        public Microsoft.Azure.RemoteRendering.Material OverrideMaterial
        {
            get
            {
                ulong result_handle;
                Microsoft.Azure.RemoteRendering.Material result_object;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_hierarchical_state_override_component_get_override_material(this.handle, out result_handle));
                result_object = (result_handle != default(ulong)) ? Factories.MaterialFactory(result_handle, transfer:true) : null;
                return result_object;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_hierarchical_state_override_component_set_override_material(this.handle, value != null ? value.handle : default(ulong)));
            }
        }
        ...
        /// <summary>
        /// Wraps around GetState/SetState for the <see cref="HierarchicalStates.UseCutPlaneFilterMask"/> feature
        /// </summary>
        ...
        /// <summary>
        /// Wraps around GetState/SetState for the <see cref="HierarchicalStates.TransparencyWritesDepth"/> feature.
        /// </summary>
        public Microsoft.Azure.RemoteRendering.HierarchicalEnableState TransparencyWritesDepthState
        {
            get
            {
                Microsoft.Azure.RemoteRendering.HierarchicalEnableState result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_hierarchical_state_override_component_get_transparency_writes_depth_state(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_hierarchical_state_override_component_set_transparency_writes_depth_state(this.handle, value));
            }
        }

        /// <summary>
        /// Wraps around GetState/SetState for the <see cref="HierarchicalStates.UseOverrideMaterial"/> feature.
        /// </summary>
        public Microsoft.Azure.RemoteRendering.HierarchicalEnableState UseOverrideMaterialState
        {
            get
            {
                Microsoft.Azure.RemoteRendering.HierarchicalEnableState result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_hierarchical_state_override_component_get_use_override_material_state(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_hierarchical_state_override_component_set_use_override_material_state(this.handle, value));
            }
        }
    ...
    /// in addition to the <see href="https://docs.microsoft.com/azure/remote-rendering/overview/features/sky">global sky light</see>. The position and orientation of the entity determines the location and direction of the light.
    /// </para>
    /// <para>
    ...
    public partial class LoadModelResult
    {
        ...
        public System.Collections.Generic.IReadOnlyList<Microsoft.Azure.RemoteRendering.ObjectBase> GetLoadedObjectsOfType(Microsoft.Azure.RemoteRendering.ObjectType type)
        {
            ...
            if (result_length > 0)
            {
                Microsoft.Azure.RemoteRendering.ObjectBase[] converted_array = new Microsoft.Azure.RemoteRendering.ObjectBase[result_length];
                for (int i = 0; i < result_length; i++)
                {
                    var handle = result_array[i];
                    converted_array[i] = Factories.ObjectBaseFactory(handle, transfer:true);
                }
                result = converted_array;
            }
            else
            {
                result = Array.Empty<Microsoft.Azure.RemoteRendering.ObjectBase>();
            }
            return result;
        }
        ...
        public System.Collections.Generic.IReadOnlyList<Microsoft.Azure.RemoteRendering.ResourceBase> GetLoadedResourceOfType(Microsoft.Azure.RemoteRendering.ObjectType type)
        {
            ...
            if (result_length > 0)
            {
                Microsoft.Azure.RemoteRendering.ResourceBase[] converted_array = new Microsoft.Azure.RemoteRendering.ResourceBase[result_length];
                for (int i = 0; i < result_length; i++)
                {
                    var handle = result_array[i];
                    converted_array[i] = Factories.ResourceBaseFactory(handle, transfer:true);
                }
                result = converted_array;
            }
            else
            {
                result = Array.Empty<Microsoft.Azure.RemoteRendering.ResourceBase>();
            }
            return result;
        }

        // Class extension begins for LoadModelResult.
        /// <summary>
        /// Retrieves all objects of the given <param name="type"> that were loaded as part of this model and puts them into <param name="resultList">.
        /// </summary>
        /// <remarks>
        /// This returns the same data as <see cref="GetLoadedObjectsOfType(ObjectType type)"/>, but won't allocate a result list.
        /// </remarks>
        public void GetLoadedObjectsOfType(ObjectType type, List<ObjectBase> resultList)
        {
            if (resultList == null) throw new ArgumentNullException(nameof(resultList));
            ...
            foreach (ulong handle in result_array)
            {
                resultList.Add(Factories.ObjectBaseFactory(handle, transfer: true));
            }
        }

        /// <summary>
        /// Retrieves all resources of the given <param name="type"> that were loaded as part of this model and puts them into <param name="resultList">.
        /// </summary>
        /// <remarks>
        /// This returns the same data as <see cref="GetLoadedResourceOfType(ObjectType type)"/>, but won't allocate a result list.
        /// </remarks>
        public void GetLoadedResourceOfType(ObjectType type, List<ResourceBase> resultList)
        {
            if (resultList == null) throw new ArgumentNullException(nameof(resultList));
            ...
            foreach (ulong handle in result_array)
            {
                resultList.Add(Factories.ResourceBaseFactory(handle, transfer: true));
            }
        }
        // Class extension ends for LoadModelResult.
    ...
    /// <seealso cref="Microsoft.Azure.RemoteRendering.RenderingConnection.CreateMaterial(Microsoft.Azure.RemoteRendering.MaterialType)"/>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/materials">Materials</seealso>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/lifetime">Object and resource lifetime</seealso>
    public partial class Material : ResourceBase
    {
        ...
        /// <summary>
        /// Which <see cref="MaterialType">kind of material</see> this is.
        /// </summary>
    ...
    /// <seealso cref="Microsoft.Azure.RemoteRendering.Material"/>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.RenderingConnection.CreateComponent(Microsoft.Azure.RemoteRendering.ObjectType,Microsoft.Azure.RemoteRendering.Entity)"/>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/meshes">Meshes</seealso>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/spatial-queries">Spatial queries</seealso>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/materials">Materials</seealso>
    public partial class MeshComponent : ComponentBase
    {
        ...
        public System.Collections.Generic.IReadOnlyList<Microsoft.Azure.RemoteRendering.Material> Materials
        {
            get
            {
                ...
                if (result_length > 0)
                {
                    Microsoft.Azure.RemoteRendering.Material[] converted_array = new Microsoft.Azure.RemoteRendering.Material[result_length];
                    for (int i = 0; i < result_length; i++)
                    {
                        var handle = result_array[i];
                        converted_array[i] = Factories.MaterialFactory(handle, transfer:true);
                    }
                    result = converted_array;
                }
                else
                {
                    result = Array.Empty<Microsoft.Azure.RemoteRendering.Material>();
                }
                return result;
            }
        }
        ...
        // Class extension begins for MeshComponent.
        /// <summary>
        /// Retrieves the list of materials set on this component and puts them into <param name="resultList">.
        /// </summary>
        /// <remarks>
        /// This returns the same data as <see cref="Materials"/>, but won't allocate a result array.
        /// </remarks>
        public void GetMaterials(List<Material> resultList)
        {
            if (resultList == null) throw new ArgumentNullException(nameof(resultList));
            ...
            foreach (ulong handle in result_array)
            {
                resultList.Add(Factories.MaterialFactory(handle, transfer: true));
            }
        }

        /// <summary>
        /// Retrieves the list of actually used materials for rendering the mesh and puts them into <param name="resultList">.
        /// </summary>
        /// <remarks>
        /// This returns the same data as <see cref="UsedMaterials"/>, but won't allocate a result array.
        /// </remarks>
        public void GetUsedMaterials(List<Material> resultList)
        {
            if (resultList == null) throw new ArgumentNullException(nameof(resultList));
        ...
        // Class extension ends for MeshComponent.
    ...
    public partial class Mesh : ResourceBase
    {
        ...
        /// </summary>
        /// <seealso cref="Microsoft.Azure.RemoteRendering.ResourceStateResult_Experimental"/>
        public async System.Threading.Tasks.Task<Microsoft.Azure.RemoteRendering.ResourceStateResult_Experimental> GetResourceStateAsync_Experimental()
        {
            using (var promise_ = Microsoft.Azure.RemoteRendering.Promise.Create(value => Microsoft.Azure.RemoteRendering.ResourceStateResult_Experimental.Create(value.Pointer), System.Threading.CancellationToken.None))
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_mesh_get_resource_state_async_experimental(this.handle, promise_.Handle));
                return await promise_.Task;
            }
        }

        // Class extension begins for Mesh.
        /// <summary>
        /// Retrieves the list of materials used for rendering the mesh, unless overridden by a <see cref="MeshComponent"/>, and puts them into <param name="resultList">.
        /// </summary>
        /// <remarks>
        /// This returns the same data as <see cref="Materials"/>, but won't allocate a result array.
        /// </remarks>
    ...
    public partial class ObjectMetadata
    {
        ...
        public System.Collections.Generic.IReadOnlyList<Microsoft.Azure.RemoteRendering.ObjectMetadataEntry> Metadata
        {
            get
            {
                ...
                if (result_length > 0)
                {
                    Microsoft.Azure.RemoteRendering.ObjectMetadataEntry[] converted_array = new Microsoft.Azure.RemoteRendering.ObjectMetadataEntry[result_length];
                    for (int i = 0; i < result_length; i++)
                    {
                        var handle = result_array[i];
                        converted_array[i] = new Microsoft.Azure.RemoteRendering.ObjectMetadataEntry(handle, transfer:true);
                    }
                    result = converted_array;
                }
                else
                {
                    result = Array.Empty<Microsoft.Azure.RemoteRendering.ObjectMetadataEntry>();
                }
                return result;
            }
        }
        ...
        // Class extension begins for ObjectMetadata.
        /// <summary>
        /// Retrieves all entries in this collection and puts them into <param name="resultList">.
        /// </summary>
        /// <remarks>
        /// This returns the same data as <see cref="Metadata"/>, but won't allocate a result list.
        /// </remarks>
        public void GetMetadata(List<ObjectMetadataEntry> resultList)
        {
            if (resultList == null) throw new ArgumentNullException(nameof(resultList));
            ...
            foreach (IntPtr handle in result_array)
            {
                resultList.Add(new Microsoft.Azure.RemoteRendering.ObjectMetadataEntry(handle, transfer: true));
            }
        }
        // Class extension ends for ObjectMetadata.
    ...
    /// </summary>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/outlines">Outline rendering</seealso>
    ...
    public partial class OutlineSettings
    {
        ...
        /// </summary>
        /// <seealso cref="Microsoft.Azure.RemoteRendering.RenderingConnection.LoadTextureAsync(Microsoft.Azure.RemoteRendering.LoadTextureOptions)"/>
        public Microsoft.Azure.RemoteRendering.Texture MaskTexture
        {
            get
            {
                ulong result_handle;
                Microsoft.Azure.RemoteRendering.Texture result_object;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_get_mask_texture(this.handle, out result_handle));
                result_object = (result_handle != default(ulong)) ? new Microsoft.Azure.RemoteRendering.Texture(result_handle, transfer:true) : null;
                return result_object;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_set_mask_texture(this.handle, value != null ? value.handle : default(ulong)));
            }
        }
        ...
        /// </summary>
        /// <remarks>
        /// This parameter is ignored if no <see cref="OutlineSettings.MaskTexture"/> is set.
        /// </remarks>
        public Microsoft.Azure.RemoteRendering.Float2 MaskScale
        {
            get
            {
                Microsoft.Azure.RemoteRendering.Float2 result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_get_mask_scale(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_set_mask_scale(this.handle, value));
            }
        }

        /// <summary>
        /// If enabled, the mask will be scaled so that it fits the viewport size rather than texture pixel size. The scaling factors <see cref="OutlineSettings.MaskScale"/> will be applied on top.
        /// </summary>
        /// <remarks>
        /// This parameter is ignored if no <see cref="OutlineSettings.MaskTexture"/> is set.
        /// </remarks>
        public bool MaskScaleToFit
        {
            get
            {
                bool result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_get_mask_scale_to_fit(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_set_mask_scale_to_fit(this.handle, value));
            }
        }
        ...
        /// This parameter is ignored if no <see cref="OutlineSettings.MaskTexture"/> is set.
        /// </remarks>
        public Microsoft.Azure.RemoteRendering.Float2 MaskOffset
        {
            get
            {
                Microsoft.Azure.RemoteRendering.Float2 result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_get_mask_offset(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_set_mask_offset(this.handle, value));
            }
        }

        /// <summary>
        /// Defines a scroll speed for <see cref="OutlineSettings.MaskOffset"/>. The final offset used for rendering is computed as FinalOffset = MaskOffset + MaskScrollSpeed * globalTimeInSeconds.
        /// </summary>
        /// <remarks>
        /// This parameter is ignored if no <see cref="OutlineSettings.MaskTexture"/> is set.
        /// </remarks>
        public Microsoft.Azure.RemoteRendering.Float2 MaskScrollSpeed
        {
            get
            {
                Microsoft.Azure.RemoteRendering.Float2 result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_get_mask_scroll_speed(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_set_mask_scroll_speed(this.handle, value));
            }
        }
        ...
        /// This parameter is ignored if no <see cref="OutlineSettings.MaskTexture"/> is set.
        /// </remarks>
        public Microsoft.Azure.RemoteRendering.Float2 MaskRotationCenter
        {
            get
            {
                Microsoft.Azure.RemoteRendering.Float2 result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_get_mask_rotation_center(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_set_mask_rotation_center(this.handle, value));
            }
        }
        ...
        /// This parameter is ignored if no <see cref="OutlineSettings.MaskTexture"/> is set.
        /// </remarks>
        public float MaskRotationAngle
        {
            get
            {
                float result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_get_mask_rotation_angle(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_set_mask_rotation_angle(this.handle, value));
            }
        }
        ...
        public float MaskRotationSpeed
        {
            ...
            {
                float result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_get_mask_rotation_speed(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_outline_settings_set_mask_rotation_speed(this.handle, value));
            }
        }
    ...
    public partial class PbrMaterial : Material
    {
        ...
        /// <remarks>
        /// <para>
        /// The new normalmap scaling factor in [0..100] range.
        /// A value of 1.0 takes the normalmap's normal as-is, a value of 0 makes the surface appear flat. Values larger than 1.0 exaggerate the normalmap perturbation.
        /// This value has no effect if this material does not specify a normalmap texture.
        /// A <see cref="Result.InvalidParam"/> error occurs if the value is outside the valid range.
        /// </para>
        /// </remarks>
        public float NormalMapScale
        {
            ...
            {
                float result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_pbr_material_get_normal_map_scale(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_pbr_material_set_normal_map_scale(this.handle, value));
            }
        }
    ...
    /// <summary>
    /// Result object that is returned by <see cref="RenderingConnection.RayCastQueryAsync(RayCast)"/>. This class holds a (potentially empty) array of.ray cast hits after an asynchronous ray cast call.
    /// </summary>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.RenderingConnection.RayCastQueryAsync(Microsoft.Azure.RemoteRendering.RayCast)"/>
    public partial class RayCastQueryResult
    {
        ...
        public Microsoft.Azure.RemoteRendering.RayCastHit[] Hits
        {
            get
            {
                ...
                if (result_length > 0)
                {
                    Microsoft.Azure.RemoteRendering.RayCastHit[] converted_array = new Microsoft.Azure.RemoteRendering.RayCastHit[result_length];
                    for (int i = 0; i < result_length; i++)
                    {
                        converted_array[i] = result[i].Convert();
                    }
                    return converted_array;
                }
                else
                {
                    return Array.Empty<Microsoft.Azure.RemoteRendering.RayCastHit>();
                }
            }
        }

        // Class extension begins for RayCastQueryResult.
        /// <summary>
        /// Retrieves all intersections that the raycast encountered and puts them into <param name="resultList">.
        /// </summary>
        /// <remarks>
        /// This returns the same data as <see cref="Hits"/>, but won't allocate a result array.
        /// </remarks>
        public void GetHits(List<RayCastHit> resultList)
        {
            if (resultList == null) throw new ArgumentNullException(nameof(resultList));
            ...
            foreach (RayCastHitAbi abiResult in result)
            {
                resultList.Add(abiResult.Convert());
            }
        }
        // Class extension ends for RayCastQueryResult.
    ...
    public partial class RemoteRenderingClient : IDisposable, ICachedObject
    {
        ...
        private static void MessageLoggedStaticHandler(ulong cookie, Microsoft.Azure.RemoteRendering.LogLevel level, System.IntPtr message)
        {
            try
            {
                ...
                if (handler != null)
                {
                    Unity.SynchronizationContextUtility.EnsureUnityMainThread(() => handler(level, message));
                }
            }
            catch (Exception e)
            {
        ...
        private static void TokenRequiredStaticHandler(ulong cookie, IntPtr args)
        {
            try
            {
                ...
                if (handler != null)
                {
                    Unity.SynchronizationContextUtility.EnsureUnityMainThread(() => handler(instance, new Microsoft.Azure.RemoteRendering.TokenRequiredEventArgs(args, transfer: false)));
                }
            }
            catch (Exception e)
            {
        ...
        /// Once ready, CreateNewRenderingSessionAsync returns the created RenderingSession object or an error context.
        /// </remarks>
        ...
        /// * A <see cref="Result.DomainUnreachable"/> error occurs if remote rendering domain is unreachable. Url may be invalid or Azure Remote Rendering is not supported in this region.
        /// * A <see cref="Result.ConnectionRefused"/> error occurs if remote rendering connection is refused by destination host.
        /// * A <see cref="Result.ConnectionFailed"/> error occurs if remote rendering connection failed. Exact reason is unknown.
        /// * A <see cref="Result.Timeout"/> error occurs if remote rendering connection timed out.
        /// </para>
        /// </remarks>
    ...
    public partial class RenderingConnection : ICachedObject
    {
        ...
        /// <summary>
        /// Retrieves the list of all root entities. A root entity is any existing entity that has no <see cref="Entity.Parent"/>. This includes root entities created through loading a model and entities created client-side. The returned entities do not appear in a specific order in the list.
        /// </summary>
        public System.Collections.Generic.IReadOnlyList<Microsoft.Azure.RemoteRendering.Entity> RootEntities
        {
            get
            {
                System.Collections.Generic.IReadOnlyList<Microsoft.Azure.RemoteRendering.Entity> result;
                ulong[] result_array;
                int result_length;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_rendering_connection_get_root_entities(this.handle, out result_array, out result_length));
                if (result_length > 0)
                {
                    Microsoft.Azure.RemoteRendering.Entity[] converted_array = new Microsoft.Azure.RemoteRendering.Entity[result_length];
                    for (int i = 0; i < result_length; i++)
        ...
        /// </summary>
        /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/stage-space">Stage space</seealso>
        ...
        /// </summary>
        /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/sky">Sky reflections</seealso>
        ...
        /// </summary>
        /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/z-fighting-mitigation">Z-fighting mitigation</seealso>
        ...
        /// </summary>
        /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/shell-effect">Shell rendering</seealso>
        ...
        private static void UpdatedStaticHandler(ulong cookie)
        {
            try
            {
                ...
                if (handler != null)
                {
                    Unity.SynchronizationContextUtility.EnsureUnityMainThread(() => handler());
                }
            }
            catch (Exception e)
            {
        ...
        /// </param>
        /// <remarks>
        /// This is a fast way to gather all mesh parts that overlap with given bounds. The individual check is performed based on each mesh part's
        /// bounds in the scene, not on individual triangles. All the information to perform this query locally are available on the client, but for
        /// scenes with large number of parts this would be impractical.
        /// This call returns immediately and emits an event when the spatial query result has arrived.
        /// The query will be performed on the server against the state of the world on the frame that the query was issued on.
        /// The result list is not sorted. Also, when the maximum number of results is exceeded, this query returns the first n results.
        /// </remarks>
        /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/spatial-queries">Spatial queries</seealso>
        public async System.Threading.Tasks.Task<Microsoft.Azure.RemoteRendering.SpatialQueryResult> SpatialQueryAsync(Microsoft.Azure.RemoteRendering.SpatialQuery query)
        {
            using (var promise_ = Microsoft.Azure.RemoteRendering.Promise.Create(value => new Microsoft.Azure.RemoteRendering.SpatialQueryResult(value.Pointer, true), System.Threading.CancellationToken.None))
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_rendering_connection_spatial_query_async(this.handle, query, promise_.Handle));
                return await promise_.Task;
            }
        }
        ...
        /// </remarks>
        /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/spatial-queries">Spatial queries</seealso>
        public async System.Threading.Tasks.Task<Microsoft.Azure.RemoteRendering.SpatialQueryResult> SpatialQueryAabbAsync(Microsoft.Azure.RemoteRendering.SpatialQueryAabb query)
        {
            using (var promise_ = Microsoft.Azure.RemoteRendering.Promise.Create(value => new Microsoft.Azure.RemoteRendering.SpatialQueryResult(value.Pointer, true), System.Threading.CancellationToken.None))
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_rendering_connection_spatial_query_aabb_async(this.handle, query, promise_.Handle));
                return await promise_.Task;
            }
        }
        ...
        /// </remarks>
        /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/spatial-queries">Spatial queries</seealso>
        public async System.Threading.Tasks.Task<Microsoft.Azure.RemoteRendering.SpatialQueryResult> SpatialQuerySphereAsync(Microsoft.Azure.RemoteRendering.SpatialQuerySphere query)
        {
            using (var promise_ = Microsoft.Azure.RemoteRendering.Promise.Create(value => new Microsoft.Azure.RemoteRendering.SpatialQueryResult(value.Pointer, true), System.Threading.CancellationToken.None))
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_rendering_connection_spatial_query_sphere_async(this.handle, query, promise_.Handle));
                return await promise_.Task;
            }
        }
        ...
        /// </remarks>
        /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/spatial-queries">Spatial queries</seealso>
        public async System.Threading.Tasks.Task<Microsoft.Azure.RemoteRendering.SpatialQueryResult> SpatialQueryObbAsync(Microsoft.Azure.RemoteRendering.SpatialQueryObb query)
        {
            using (var promise_ = Microsoft.Azure.RemoteRendering.Promise.Create(value => new Microsoft.Azure.RemoteRendering.SpatialQueryResult(value.Pointer, true), System.Threading.CancellationToken.None))
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_rendering_connection_spatial_query_obb_async(this.handle, query, promise_.Handle));
                return await promise_.Task;
            }
        }
        ...
        // Class extension begins for RenderingConnection.
        /// <summary>
        /// Retrieves the list of all root entities and puts them into <param name="resultList">.
        /// A root entity is any existing entity that has no <see cref="Entity.Parent"/>.
        /// This includes root entities created through loading a model and entities created client-side. The returned entities do not appear in a specific order in the list.
        /// </summary>
        /// <remarks>
        /// This returns the same data as <see cref="RootEntities"/>, but won't allocate a result array.
        /// </remarks>
        public void GetRootEntities(List<Entity> resultList)
        {
            if (resultList == null) throw new ArgumentNullException(nameof(resultList));
        ...
        // Class extension ends for RenderingConnection.
    ...
    public partial class RenderingSession : ICachedObject
    {
        ...
        private static void ConnectionStatusChangedStaticHandler(ulong cookie, Microsoft.Azure.RemoteRendering.ConnectionStatus status, Microsoft.Azure.RemoteRendering.Result error)
        {
            try
            {
                ...
                if (handler != null)
                {
                    Unity.SynchronizationContextUtility.EnsureUnityMainThread(() => handler(status, error));
                }
            }
            catch (Exception e)
            {
        ...
        /// </para>
        /// </remarks>
        /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/resources/tools/arr-inspector">The ArrInspector inspection tool</seealso>
        ...
        /// * A <see cref="Result.ConnectionFailed"/> error occurs if remote rendering connection failed. Exact reason is unknown.
        /// * A <see cref="Result.Timeout"/> error occurs if remote rendering connection timed out.
        /// * A <see cref="Result.UnsupportedDisplayAdapter"/> error occurs if an unsupported display adapter is detected.
        /// </para>
        /// </remarks>
    ...
    /// <summary>
    /// Result object that is returned by <see cref="RemoteRenderingClient.GetCurrentRenderingSessionsAsync"/>. Success state and additional error context can be retrieved via base class <see cref="SessionContextResult"/>. In case of success, the SessionProperties property holds a valid array of <see cref="RenderingSessionProperties"/> instances.
    /// </summary>
    public partial class RenderingSessionPropertiesArrayResult : SessionContextResult
    {
        ...
        /// <summary>
        /// In case of success, the SessionProperties property holds a valid array of <see cref="RenderingSessionProperties"/> instances.
        /// </summary>
    ...
    /// <summary>
    /// Result object that is returned by <see cref="RenderingSession.GetPropertiesAsync"/>. Success state and additional error context can be retrieved via base class <see cref="SessionContextResult"/>. In case of success, the SessionProperties property holds a valid instance of <see cref="RenderingSessionProperties"/>.
    /// </summary>
    public partial class RenderingSessionPropertiesResult : SessionContextResult
    {
        ...
        /// <summary>
        /// In case of success, the SessionProperties property holds a valid instance of <see cref="RenderingSessionProperties"/>.
        /// </summary>
        public Microsoft.Azure.RemoteRendering.RenderingSessionProperties SessionProperties
        {
            get
    ...
    /// <summary>
    /// Base result class for all session related async queries. This result has an ErrorCode property to test whether the query was successful. In case of error, additional information can be gathered through the Context object. See <see cref="SessionGeneralContext"/>
    /// </summary>
    public partial class SessionContextResult
    {
        ...
        /// <summary>
        /// Indicates whether the query was successful or not. See <see cref="Result"/> for details in case of failure. In case of failure, additional information can be gathered from <see cref="SessionContextResult.Context"/>.
        /// </summary>
    ...
    public partial class SkyReflectionSettings
    {
        ...
        /// </summary>
        /// <remarks>
        /// It is recommended to use a normalized quaternion, since that yields an intuitive representation
        /// of a rotation but it is not required. The quaternion will be normalized internally.
        /// <para>
        /// * A <see cref="Result.InvalidParam"/> error occurs if the provided quaternion is invalid.
        /// </para>
        /// </remarks>
        /// <seealso cref="Microsoft.Azure.RemoteRendering.Quaternion"/>
        public Microsoft.Azure.RemoteRendering.Quaternion SkyRotation
        {
            get
            {
                Microsoft.Azure.RemoteRendering.Quaternion result;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_sky_reflection_settings_get_sky_rotation(this.handle, out result));
                return result;
            }
            set
            {
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_sky_reflection_settings_set_sky_rotation(this.handle, value));
            }
        }
    ...
    /// <seealso cref="Microsoft.Azure.RemoteRendering.RenderingConnection.SpatialQueryAsync(Microsoft.Azure.RemoteRendering.SpatialQuery)"/>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/overview/features/spatial-queries">Spatial Queries</seealso>
    public partial class SpatialQueryResult
    {
        internal IntPtr handle;

        internal SpatialQueryResult(IntPtr ahandle, bool transfer)
        {
            this.handle = ahandle;
            if (!transfer) Microsoft.Azure.RemoteRendering.NativeLibrary.arr_spatial_query_result_addref(ahandle);
        }

        ~SpatialQueryResult()
        {
            Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_spatial_query_result_release(this.handle));
            this.handle = IntPtr.Zero;
        }
        ...
        /// </summary>
        public System.Collections.Generic.IReadOnlyList<Microsoft.Azure.RemoteRendering.MeshComponent> Overlaps
        {
            get
            {
                System.Collections.Generic.IReadOnlyList<Microsoft.Azure.RemoteRendering.MeshComponent> result;
                ulong[] result_array;
                int result_length;
                Microsoft.Azure.RemoteRendering.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.RemoteRendering.NativeLibrary.arr_spatial_query_result_get_overlaps(this.handle, out result_array, out result_length));
                if (result_length > 0)
                {
                    Microsoft.Azure.RemoteRendering.MeshComponent[] converted_array = new Microsoft.Azure.RemoteRendering.MeshComponent[result_length];
                    for (int i = 0; i < result_length; i++)
                    {
                        var handle = result_array[i];
                        converted_array[i] = new Microsoft.Azure.RemoteRendering.MeshComponent(handle, transfer:true);
                    }
                    result = converted_array;
                }
                else
                {
                    result = Array.Empty<Microsoft.Azure.RemoteRendering.MeshComponent>();
                }
                return result;
            }
        }

        // Class extension begins for SpatialQueryResult.
        /// <summary>
        /// Retrieves the mesh components that overlap with the volume defined in the input parameters and puts them into <param name="resultList">.
        /// The maximum length of this list is determined by the MaxResults member in the input.
        /// </summary>
        /// <remarks>
        /// This returns the same data as <see cref="Overlaps"/>, but won't allocate a result list.
        /// </remarks>
        public void GetOverlaps(List<MeshComponent> resultList)
        {
            if (resultList == null) throw new ArgumentNullException(nameof(resultList));
            ...
            foreach (ulong handle in result_array)
            {
                resultList.Add(new Microsoft.Azure.RemoteRendering.MeshComponent(handle, transfer: true));
            }
        }
        // Class extension ends for SpatialQueryResult.
    ...
    /// <seealso cref="Microsoft.Azure.RemoteRendering.RenderingConnection.LoadTextureAsync(Microsoft.Azure.RemoteRendering.LoadTextureOptions)"/>
    /// <seealso cref="Microsoft.Azure.RemoteRendering.RenderingConnection.LoadTextureFromSasAsync(Microsoft.Azure.RemoteRendering.LoadTextureFromSasOptions)"/>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/concepts/textures">Textures (Remote Rendering documentation)</seealso>
    ...
    /// </summary>
    /// <seealso href="https://docs.microsoft.com/azure/remote-rendering/how-tos/frontend-apis">Use the Azure Frontend APIs for authentication</seealso>
